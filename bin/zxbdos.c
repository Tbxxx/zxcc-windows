...
*/
		...
		default:
				...
				fprintf(stderr,"%s: Unsupported BDOS call %d-%02x\n", progname, 
				(int)(R->BC.B.l),(int)(R->BC.B.l));	
			dump_regs(R);
			zxcc_exit(1);
			break;	
	}
...
#if 0
/* no console -0 disk calls only */	
strncpy(tmpfilen, pde+1, 11);
if (R->BC.B.l > 0x0c) {
	switch(R->BC.B.l) {
		case 0x0C:	printf("0C - Get CP/M version\n");	break;
		case 0x0D:	printf("0D - Re-log discs\n");	break;
		case 0x0E:	printf("0F - Set default drive\n");	break;
		case 0x0F:	printf("0F - Open using FCB - [%s]\n", tmpfilen);	break;
		case 0x10:	printf(" Close using FCB - [%s]\n", tmpfilen);	break;
		case 0x11:	printf(" Find first - [%s]\n", tmpfilen);	break;
		case 0x12:	printf("Unmarked\n");	break;
		case 0x13:	printf(" Delete using FCB - [%s]\n", tmpfilen);	break;
		case 0x14:	printf(" Sequential read using FCB - [%s]\n", tmpfilen);	break;
		case 0x15:	printf(" Sequential write using FCB - [%s]\n", tmpfilen);	break;
		case 0x16:	printf(" Create using FCB - [%s]\n", tmpfilen);	break;
		case 0x17:	printf(" Rename using FCB - [%s]\n", tmpfilen);	break;
		case 0x18:	printf(" Get login vector\n");	break;
		case 0x19:	printf(" Get default drive\n");	break;
		case 0x1A:	printf(" Set DMA\n");	break;
		case 0x1B:	printf(" Get alloc vector\n");	break;
		case 0x1C:	printf(" Make disc R/O\n");	break;
		case 0x1D:	printf(" Get R/O vector\n");	break;
		case 0x1E:	printf(" Set attributes\n");	break;
		case 0x1F:	printf(" Get DPB\n", tmpfilen);	break;
		case 0x20:	printf(" Get/set uid\n");	break;
		case 0x21:	printf(" Read a record - [%s]\n", tmpfilen);	break;
		case 0x22:	printf(" Write a record - [%s]\n", tmpfilen);	break;
		case 0x23:	printf(" Get file size - [%s]\n", tmpfilen);	break;
		case 0x24:	printf(" Get file pointer - [%s]\n", tmpfilen);	break;
		case 0x25:	printf("Unmarked\n");	break;
		case 0x28:	printf(" Write with 0 fill - [%s]\n", tmpfilen);	break;
		case 0x2C:	printf(" Set no. of records to read/write\n");	break;
		case 0x2D:	printf(" Set error mode\n");	break;
		case 0x2E:	printf("Unmarked\n");	break;
		case 0x30:	printf("Unmarked\n");	break;
		case 0x31:	printf("Unmarked\n");	break;
		case 0x32:	printf("Unmarked\n");	break;
		case 0x3C:	printf(" Communicate with RSX\n");	break;
		case 0x62:	printf(" Purge\n");	break;
		case 0x63:	printf(" Truncate file - [%s]\n", tmpfilen);	break;
		case 0x64:	printf(" Set label\n");	break;
		case 0x65:	printf(" Get label byte\n");	break;
		case 0x66:      printf(" Get file date\n");	break;
		case 0x67:	printf(" Set password\n");	break;
		case 0x68:	printf(" Set time of day\n");	break;
		case 0x69:	printf(" Get time of day\n");	break;
		case 0x6A:	printf(" Set default password\n");	break;
		case 0x6B:	printf(" Get serial number\n");	break;
		case 0x6C:	printf(" 0.03 set error code\n");	break;
		case 0x6D:	printf(" Set/get console mode\n");	break;
		case 0x6E:	printf(" Set/get string delimiter\n");	break;
		case 0x6F:	printf(" Send fixed length string to screen\n");	break;
		case 0x70:	printf(" Send fixed length string to printer\n");	break;
		case 0x74:	printf(" Set date stamp\n");	break;
		case 0x98:	printf(" Parse filename\n");	break;
		case 240:	printf(" not real - used by exit.com as graceful exit\n");	break;
	}	
}
#endif
